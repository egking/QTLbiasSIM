...
load(file="Data/DGRP/SimPhenos/DGRP_validate_btwpop.rda")
...
{
line.set<-sample(colnames(phenos[,5:ncol(phenos)]),samps)
ccc<-phenos[i,'CHROM']
ppp<-phenos[i,'POS']
...
save(set, file=paste("Data/DGRP/Obs_LODs/Validate_LODs_btw_DGRP_",samps,".rda",sep=""))
